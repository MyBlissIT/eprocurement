...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var bidForm = document.getElementById('eproc-bid-form');
    var formChanged = false;
    var formSubmitted = false;

    if (bidForm) {
        // Track changes on any input/select/textarea inside the form.
        bidForm.addEventListener('change', function() {
            formChanged = true;
            showUnsavedIndicator();
        });
        bidForm.addEventListener('input', function(e) {
        ...
        // Mark as submitted (don't warn on intentional save).
        ...
        function showUnsavedIndicator() {
            var existing = document.querySelector('.eproc-unsaved-warning');
            if (!existing) {
                var warning = document.createElement('div');
                warning.className = 'eproc-unsaved-warning is-visible';
                warning.innerHTML = '<svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg> <?php echo esc_js( __( 'Unsaved changes', 'eprocurement' ) ); ?>';
