...
$nav_items[] = [
    ...
    'label' => __( 'Online Bids', 'eprocurement' ),
    'cap'   => 'eproc_view_dashboard',
];
    ...
    <nav class="eproc-admin-sidebar">
        <div class="eproc-sidebar-brand">
            ...
            <?php if ( $unread_count > 0 ) : ?>
                <a href="<?php echo esc_url( $manage_base . '/messages/' ); ?>" class="eproc-notification-bell has-unread" aria-label="<?php echo esc_attr( sprintf( __( '%d unread messages', 'eprocurement' ), $unread_count ) ); ?>" title="<?php echo esc_attr( sprintf( __( '%d unread messages', 'eprocurement' ), $unread_count ) ); ?>">
