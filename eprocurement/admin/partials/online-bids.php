...
<div class="eproc-wrap">
    ...
    <div class="eproc-filter-bar">
        <form method="get" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>" class="eproc-flex-row">
            <input type="hidden" name="page" value="eprocurement-online-bids">
            ...
            <?php if ( $filter_status ) : ?>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=eprocurement-online-bids' ) ); ?>" class="button"><?php esc_html_e( 'Clear', 'eprocurement' ); ?></a>
            <?php endif; ?>
            ...
            <table class="wp-list-table widefat">
                ...
                <tbody>
                    <?php foreach ( $items as $bid ) : ?>
                        <tr>
                            <td>
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=eprocurement-bids&action=edit&id=' . $bid->id ) ); ?>">
                            ...
                            <td style="text-align:center;">
                                <?php if ( (int) $bid->bidder_count > 0 ) : ?>
                                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=eprocurement-bids&action=edit&id=' . $bid->id . '#submissions' ) ); ?>"
